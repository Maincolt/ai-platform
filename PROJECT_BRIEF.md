...
> Last updated: 2026-08-15 | `assignment.route` (ADR-0023) added with its `submit-assignment.py` team-dispatch script, live-verified on the Mac Docker host; the platform now has eight capabilities | Status: In progress
...
[README.md](README.md)). Twenty-three Accepted ADRs govern the platform.
